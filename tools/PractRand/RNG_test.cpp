...
public:
	...
	void walk_state(PractRand::StateWalkingObject *walker) {
		...
		rng_get(pS0, pS1, pS2, pS3, &p0, &p1);

		std::printf("State: %08x %08x %08x %08x (p0=%d p1=%d)\n", *pS0, *pS1, *pS2, *pS3, p0, p1);
	}
	
	std::string get_name() const {return "BestRandom";}
};
...
int main(int argc, char **argv) {
	...
	RNG_Factories::RNG_factory_index["best"] = RNG_Factories::_generic_notrecommended_RNG_factory<DummyRNG>;
